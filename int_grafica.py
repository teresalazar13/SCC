...
class MenuSimulator(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        chegA = tk.Entry(self, validate="key", validatecommand=vcmd, textvariable=chegADef)
        label_chegA.pack()
        chegA.pack()
        chegA.focus_set()
        ...
        chegB = tk.Entry(self, validate="key", validatecommand=vcmd, textvariable=chegBDef)
        label_chegB.pack()
        chegB.pack()
        chegB.focus_set()
        ...
        perf_atendA = tk.Entry(self, validate="key", validatecommand=vcmd, textvariable=perf_atendADef)
        ...
        perf_desvioA = tk.Entry(self, validate="key", validatecommand=vcmd, textvariable=perf_desvioADef)
        ...
        perf_mediaA = tk.Entry(self, validate="key", validatecommand=vcmd, textvariable=perf_mediaADef)
        ...
        perf_atendB = tk.Entry(self, validate="key", validatecommand=vcmd, textvariable=perf_atendBDef)
        ...
        perf_desvioB = tk.Entry(self, validate="key", validatecommand=vcmd, textvariable=perf_desvioBDef)
        ...
        perf_mediaB = tk.Entry(self, validate="key", validatecommand=vcmd, textvariable=perf_mediaBDef)
        ...
        pol_atendA = tk.Entry(self, validate="key", validatecommand=vcmd, textvariable=pol_atendADef)
        ...
        pol_desvioA = tk.Entry(self, validate="key", validatecommand=vcmd, textvariable=pol_desvioADef)
        ...
        pol_mediaA = tk.Entry(self, validate="key", validatecommand=vcmd, textvariable=pol_mediaADef)
        ...
        pol_atendB = tk.Entry(self, validate="key", validatecommand=vcmd, textvariable=pol_atendBDef)
        ...
        pol_desvioB = tk.Entry(self, validate="key", validatecommand=vcmd, textvariable=pol_desvioBDef)
        ...
        pol_mediaB = tk.Entry(self, validate="key", validatecommand=vcmd, textvariable=pol_mediaBDef)
        label_mediaPolB.pack()
        pol_mediaB.pack()
        ...
        env_atend = tk.Entry(self, validate="key", validatecommand=vcmd, textvariable=env_atendDef)
        ...
        env_desvio = tk.Entry(self, validate="key", validatecommand=vcmd, textvariable=env_desvioDef)
        ...
        button1 = tk.Button(self, text="SIMULAR", command=lambda: callback(), width=15, font=FONT)
        button1.pack()
